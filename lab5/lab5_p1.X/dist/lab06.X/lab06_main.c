...
int main(int argc, char** argv) {
   ...
   int speed_low = 0X33FF; // declare direction
 ...
 //If the right sensor reads black then change direction to the left
...
writeLEDs(0b1000);
 ...
 LFORWARD = speed_high;
   ...
   //If the left sensor reads black then change direction to the left
  ...
  LFORWARD = speed_low;
   ...
   // When the senser read black in both sides then it eeps going forward
